...
class Conjuntos:  #operaciones (identacion)
    ...
    def agregar_2(self):
        ...
        print("conjunto B=",self.conjunto_B)
        numero = int(input("introduzca el elemnto>> "))
    ...
    def verificar_A(self):
        print("Verificar si un elemento pertenece\n al conjunto A")
        print("conjunto A=",self.conjunto_A)
    ...
    def espacio(self):
        print("has seleccionado ver el espacio entre dos conjuntos")
        "conjunto A=", print(self.conjunto_A)
        "conjunto B=",print(self.conjunto_B)
        "espacio=",print(self.conjunto_A |self.conjunto_B) #el espacio en el conjunto viene a ser todos los elementos que se
        #se encuentren tanto fuera como dentro de el